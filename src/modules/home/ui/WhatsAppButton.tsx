...
export const WhatsAppButton = ({
  ...
  return (
    <a
      ...
      className={`inline-flex items-center justify-center gap-3 px-8 py-4 group rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl bg-[#25D366] hover:bg-[#128C7E] text-white font-bold text-lg hover:-translate-y-1 ${className}`}
    >
      <svg 
